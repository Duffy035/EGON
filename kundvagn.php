...
<div class="container">
	...
	<?php
	 foreach ($_SESSION['cart'] as $item => $cart_item) { $productid = $cart_item["productid"]; ?>
		...
		<strong>Total Pris:</strong> <?php echo $cart_item['price'] * $cart_item['qty']; ?> <a href="edit_cart.php?productid=<?php echo $productid; ?>">Ta bort</a><?php echo $productid; ?><hr>
	<?php } ?>
</div>
